using DogMaster.Application.Contexts.Catalog.Commands.AddLesson;
using DogMaster.Application.Contexts.Catalog.Commands.AddModule;
using DogMaster.Application.Contexts.Catalog.Commands.CreateCourse;
