using DogMaster.Application.Contexts.Learning.Commands.CompleteLesson;
using DogMaster.Application.Contexts.Learning.Commands.EnrollStudent;
using DogMaster.Application.Contexts.Learning.Queries.GetEnrollmentProgress;
