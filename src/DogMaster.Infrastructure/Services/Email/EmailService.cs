...
namespace DogMaster.Infrastructure.Services.Email;
...
{
    private readonly string _from = configuration["Email:From"] ?? "noreply@dogmasterpro.com.br";
    private readonly string _fromName = configuration["Email:FromName"] ?? "DogMaster Pro";
    ...
    private readonly string _frontendUrl = configuration["FrontendUrl"] ?? "https://app.dogmasterpro.com.br";
    ...
    public async Task SendWelcomeAsync(string to, string firstName, string confirmationToken, CancellationToken ct = default)
    {
        ...
        var body = $"""
            <h2>Olá, {firstName}! Bem-vindo(a) à DogMaster Pro 🐕</h2>
            ...
            """;
        await SendAsync(to, $"Bem-vindo(a) à DogMaster Pro, {firstName}!", body, ct);
    }
    ...
    public async Task SendPasswordResetAsync(string to, string firstName, string resetToken, CancellationToken ct = default)
    {
        ...
        var body = $"""
            <h2>Redefinição de Senha — DogMaster Pro</h2>
            ...
            """;
        await SendAsync(to, "Redefinição de senha — DogMaster Pro", body, ct);
    }
    ...
    public async Task SendPaymentConfirmedAsync(string to, string firstName, decimal amount, CancellationToken ct = default)
    {
        var body = $"""
            ...
            <p>Sua assinatura está ativa. Bons treinos com seu cão!</p>
            ...
            """;
        await SendAsync(to, "Pagamento confirmado — DogMaster Pro", body, ct);
    }
    ...
    public async Task SendCertificateAsync(string to, string firstName, string courseTitle, string certificateUrl, CancellationToken ct = default)
    {
        var body = $"""
            ...
            <a href="{certificateUrl}" style="background:#1B2D4F;color:white;padding:12px 24px;border-radius:6px;text-decoration:none;">
                Baixar Certificado
            </a>
            """;
