...
// Compra avulsa de curso (pagamento único) — modelo principal de monetização do HiMentor.
// Espelha o wrapper de subscriptionsApi acima, só que para o endpoint de compra avulsa
// (HiMentor.Sales.Api.Controllers.CoursePurchasesController), que já existia no backend mas
...
// ─── Onboarding financeiro do criador (subconta Asaas/BaaS criada pela própria HiMentor) ──────
