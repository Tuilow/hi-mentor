...
import {
  ...
  LayoutDashboard, Users, CreditCard, LogOut, Menu, Crown, Ticket, Award,
} from 'lucide-react';
        ...
        <nav className="flex-1 px-3 py-4 flex flex-col gap-0.5 overflow-y-auto">
          ...
          {hasAnyCourseAccess && (
            <>
              ...
              {/* Feature 12/08/2026: certificado é emitido automaticamente ao concluir um curso
                  (CourseCompletedEventHandler) — quem não tem nenhum acesso a curso nunca teria
                  um certificado, então segue o mesmo gate de "Minha Jornada" acima. A própria
                  página trata a lista vazia com "Nenhum certificado ainda". */}
              <NavLink href="/certificados" label="Certificados" icon={Award} />
            </>
          )}
