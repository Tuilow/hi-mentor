 ...
 * hi-mentor-landing-page.md ("HiMentor é a empresa, Hi Mentor é o produto").
 *
 ...
 * 2) Vários blocos do protótipo descrevem funcionalidades que a HiMentor real
        ...
        <div className="max-w-6xl mx-auto px-6 py-16">
          <div className="grid grid-cols-2 md:grid-cols-5 gap-8 mb-12">
            <div className="col-span-2">
              ...
              <p className="text-white/25 text-xs mt-3">Um produto da HiMentor</p>
            </div>
            {[
          ...
          <div className="border-t border-white/10 pt-8 flex flex-col md:flex-row items-center justify-between gap-4">
            <p className="text-white/30 text-xs">© {new Date().getFullYear()} HiMentor. Todos os direitos reservados.</p>
          </div>
        </div>
      </footer>
    </div>
