...
) : IRequestHandler<PurchaseCourseCommand, PurchaseCourseResponse>
{
    public async Task<PurchaseCourseResponse> Handle(PurchaseCourseCommand request, CancellationToken ct)
    {
        ...
        // fallback Legacy (conta da própria Tuilow) como rede de segurança para quem vendia pelo
        ...
        // Legacy — cobrança na própria conta Asaas da Tuilow. Mecânica de cobrança inalterada, mas
