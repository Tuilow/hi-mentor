...
public class SyncCreatorOnboardingAccountStatusCommandHandlerTests
{
    ...
    [Fact]
    public async Task Handle_SubaccountAlreadyApproved_NeverCallsAsaas()
    {
        // Estado final -- não há motivo para reconsultar (e evita ficar batendo na Asaas para
        // sempre depois de aprovado).
