...
public sealed class Lesson : Entity
{
    ...
    /// <summary>Atualiza título/descrição de uma aula já criada (passo 3 do assistente — editar
    /// uma aula existente, ex.: adicionar descrição depois de já ter vinculado o vídeo).</summary>
