...
/// <summary>
/// Onboarding financeiro do criador via subconta Asaas (BaaS) criada pela própria HiMentor —
...
///
/// Diferença fundamental para <see cref="CreatorAsaasAccount"/>: aqui é a HIMENTOR quem cria a
...
///
/// ApiKeyEncrypted é a API Key DA PRÓPRIA SUBCONTA (não a da HiMentor) — devolvida pela Asaas uma
