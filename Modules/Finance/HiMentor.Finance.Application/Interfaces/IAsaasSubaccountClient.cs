...
public interface IAsaasSubaccountClient
{
    ...
    /// <summary>POST /v3/myAccount/documents/{id} — só válido para documentos sem OnboardingUrl (ver CreatorAsaasOnboardingDocument). O arquivo é sempre um proxy de stream direto para a Asaas, nunca persistido pela HiMentor.</summary>
    ...
    /// pra HiMentor (a compra fica presa em "Pending" para sempre). Reaproveita a mesma url já
