...
/// própria Tuilow — modelo que substitui o fluxo legado de "cole sua API Key" (ver
/// <see cref="Tuilow.Finance.Domain.Entities.CreatorAsaasAccount"/>, mantido só por
...
/// <see cref="Tuilow.Finance.Domain.Entities.CreatorAsaasSubaccount"/>).
/// </summary>
public enum CreatorOnboardingStatus
{
    ...
    /// <summary>Bloqueado manualmente por um admin da Tuilow (ex.: suspeita de fraude).</summary>
    Blocked = 8
}
