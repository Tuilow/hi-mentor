using HiMentor.Finance.Application.Commands.AdminSetCreatorAsaasAccountEnabled;
using HiMentor.Finance.Application.Commands.AdminSetCreatorCommissionOverride;
using HiMentor.Finance.Application.Commands.AdminSetCreatorOnboardingBlocked;
using HiMentor.Finance.Application.Commands.UpdatePlatformFee;
using HiMentor.Finance.Application.Queries.AdminListCreatorAsaasAccounts;
using HiMentor.Finance.Application.Queries.AdminListCreatorOnboardings;
using HiMentor.Finance.Application.Queries.GetCreatorFinancialDashboard;
using HiMentor.Finance.Application.Queries.GetCreatorSalesHistory;
using HiMentor.Finance.Application.Queries.GetPlatformRevenue;
