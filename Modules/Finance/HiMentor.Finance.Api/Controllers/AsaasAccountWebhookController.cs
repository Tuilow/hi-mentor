...
using HiMentor.Finance.Application.Commands.ProcessAsaasAccountStatusWebhook;
...
/// <summary>
/// Webhook de status de conta (ACCOUNT_STATUS_*) das subcontas criadas pela HiMentor via BaaS — rota
