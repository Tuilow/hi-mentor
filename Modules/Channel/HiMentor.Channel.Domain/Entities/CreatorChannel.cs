...
using HiMentor.Channel.Domain.ValueObjects;

namespace HiMentor.Channel.Domain.Entities;
...
/// <summary>
/// Canal do Criador — perfil público (himentor.com/canal/@handle) com a vitrine de todos os
