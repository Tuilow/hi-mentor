using HiMentor.Channel.Application.Commands.UpsertChannel;
using HiMentor.Channel.Application.Queries.GetMyChannel;
using HiMentor.Channel.Application.Queries.GetPublicChannel;
using HiMentor.SharedKernel.Application.Interfaces;
using MediatR;
using Microsoft.AspNetCore.Authorization;
using Microsoft.AspNetCore.Mvc;

namespace HiMentor.Channel.Api.Controllers;

/// <summary>
/// Canal do Criador — vitrine pública em himentor.com/canal/{handle} com todos os cursos
