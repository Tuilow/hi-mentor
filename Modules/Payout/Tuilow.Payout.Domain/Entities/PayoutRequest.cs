...
using Tuilow.Payout.Domain.Enums;
using Tuilow.Payout.Domain.Events;
...
/// (módulo Finance). O ciclo de pagamento do Tuilow é quinzenal (dia 01-15 e dia 16-fim do
/// mês) — ver Tuilow.Finance.Domain.Common.PayoutCycleCalculator — mas a solicitação em si
