...
///   - Legacy: cobrança criada na conta Asaas da própria HiMentor; a comissão é calculada e
...
///     HiMentor para a walletId da plataforma — o restante já fica com o criador, sem passar pela
///     HiMentor em nenhum momento. Ver módulo Finance (CreatorAsaasAccount) e
...
public sealed class CoursePurchase : AggregateRoot
{
    ...
    /// <summary>Valor previsto da comissão da HiMentor no momento da compra (bruto x percentual) — só para MarketplaceSplit.</summary>
    ...
    /// <summary>Modelo legado — cobrança na conta Asaas da própria HiMentor. Assinatura preservada (compras antigas e o job de reconciliação dependem dela).</summary>
    ...
    /// para a HiMentor. commissionPercentage já vem resolvido pelo caller (override do criador ou
