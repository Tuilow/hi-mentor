...
/// emissor/vendedor da cobranca) -- nao na conta da propria Tuilow. Usado apenas quando o
...
/// Tuilow -- o caller (Application) so passa creatorId, nunca ve a API Key em nenhum momento.
///
/// Contrato deliberadamente separado de IPaymentService (que continua servindo o modelo Legacy,
/// cobranca na conta da propria Tuilow) -- evita qualquer risco de um caminho de codigo
