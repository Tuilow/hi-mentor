...
public interface ICreatorPaymentAccountLookup
{
    ...
    /// <summary>
    /// Onboarding financeiro do novo modelo (subconta Asaas/BaaS criada pela HiMentor, ver
    ...
    /// nunca deixar a venda cair silenciosamente no fallback Legacy (conta da própria HiMentor) para
