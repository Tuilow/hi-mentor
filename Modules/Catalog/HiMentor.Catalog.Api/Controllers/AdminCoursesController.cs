using HiMentor.Catalog.Application.Queries.GetCourseByIdAdmin;
using HiMentor.Catalog.Application.Queries.ListCoursesAdmin;
...
/// Split de HiMentor.API.Controllers.AdminController (as rotas de curso que viviam lá).
