using HiMentor.Learning.Application.Commands.CompleteLesson;
using HiMentor.Learning.Application.Commands.EnrollFreeCourseAnonymous;
using HiMentor.Learning.Application.Commands.EnrollStudent;
using HiMentor.Learning.Application.Commands.RedeemAccessCode;
using HiMentor.Learning.Application.Queries.GetContinueWatching;
using HiMentor.Learning.Application.Queries.GetEnrollmentProgress;
using HiMentor.Learning.Application.Queries.GetLessonHistory;
using HiMentor.Learning.Application.Queries.GetMyEnrollments;
using HiMentor.SharedKernel.Application.Interfaces;
using MediatR;
using Microsoft.AspNetCore.Authorization;
using Microsoft.AspNetCore.Mvc;

namespace HiMentor.Learning.Api.Controllers;
